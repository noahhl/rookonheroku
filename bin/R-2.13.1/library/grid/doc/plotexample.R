### R code from vignette source 'plotexample.Snw'

###################################################
### code chunk number 1: plotexample.Snw:28-33
###################################################
library(grDevices)
...
###################################################
### code chunk number 2: plotexample.Snw:88-90
###################################################
x <- runif(10)
y <- runif(10)
...
###################################################
### code chunk number 5: plotexample.Snw:125-126
###################################################
pushViewport(data.vp)
grid.points(x, y)
grid.rect()
...
###################################################
### code chunk number 7: plotexample.Snw:142-144
###################################################
pushViewport(data.vp)
grid.points(x, y)
grid.rect()
...
###################################################
### code chunk number 8: plotexample.Snw:159-180
###################################################
...
###################################################
### code chunk number 9: plotexample.Snw:186-190
###################################################
...
###################################################
### code chunk number 13: plotexample.Snw:266-268
###################################################
grid.rect(gp = gpar(fill = "grey"))
message <-
    paste("I could draw all sorts",
...
###################################################
### code chunk number 14: plotexample.Snw:295-331
###################################################
...
###################################################
### code chunk number 16: plotexample.Snw:348-353
###################################################
...
###################################################
### code chunk number 17: plotexample.Snw:401-403
###################################################
splot(1:10, 1:10, "Same as Before", name = "splot")
...
###################################################
### code chunk number 18: plotexample.Snw:404-407
###################################################
sg <- splot(1:10, 1:10, "Same as Before", name = "splot", draw = FALSE)
...
###################################################
### code chunk number 19: plotexample.Snw:413-415
###################################################
splot(1:10, 1:10, "Same as Before", name = "splot")
...
###################################################
### code chunk number 20: plotexample.Snw:416-420
###################################################
sg <- splot(1:10, 1:10, "Same as Before", name = "splot", draw = FALSE)
...
###################################################
### code chunk number 21: plotexample.Snw:428-440
###################################################
...
###################################################
### code chunk number 22: plotexample.Snw:441-444
###################################################
sg <- splot(1:10, 1:10, "Same as Before", name = "splot", draw = FALSE)
...
###################################################
### code chunk number 23: plotexample.Snw:455-496
###################################################
...
###################################################
### code chunk number 24: plotexample.Snw:501-506
###################################################
splom(df)
...
###################################################
### code chunk number 26: plotexample.Snw:509-515
###################################################
smg <- splom(df, draw = FALSE)
...
###################################################
### code chunk number 27: plotexample.Snw:525-530
###################################################
splom(df, name = "splom")
grid.remove("cell12")
...
###################################################
### code chunk number 28: plotexample.Snw:531-537
###################################################
smg <- splom(df, draw = FALSE)
...
###################################################
### code chunk number 29: plotexample.Snw:545-561
###################################################
splom(df, name = "splom")
grid.remove("cell12")
grid.add("splom", textGrob(date(), name = "date",
...
###################################################
### code chunk number 30: plotexample.Snw:562-575
###################################################
smg <- splom(df, draw = FALSE)
smg <- removeGrob(smg, "cell12")
smg <- addGrob(smg, textGrob(date(), name = "date",
