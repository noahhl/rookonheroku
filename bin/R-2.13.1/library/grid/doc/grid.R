### R code from vignette source 'grid.Snw'

###################################################
### code chunk number 1: grid.Snw:26-32
###################################################
library(grDevices)
...
###################################################
### code chunk number 2: grid.Snw:74-75 (eval = FALSE)
###################################################
...
###################################################
### code chunk number 18: grid.Snw:648-665
###################################################
