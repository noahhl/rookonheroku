### R code from vignette source 'displaylist.Snw'

###################################################
### code chunk number 1: displaylist.Snw:23-29
###################################################
library(grDevices)
...
###################################################
### code chunk number 5: displaylist.Snw:99-100 (eval = FALSE)
###################################################
## grid.edit("gr", gp = gpar(col = "red", lwd = 3))


###################################################
### code chunk number 6: displaylist.Snw:130-131
###################################################
grid.rect(width = convertWidth(unit(1, "inches"), "npc"))


###################################################
### code chunk number 7: displaylist.Snw:139-144
###################################################
...
###################################################
### code chunk number 8: displaylist.Snw:158-174
###################################################
...
###################################################
### code chunk number 9: displaylist.Snw:181-199
###################################################
...
###################################################
### code chunk number 10: displaylist.Snw:208-213
###################################################
...
###################################################
### code chunk number 11: displaylist.Snw:229-238
###################################################
