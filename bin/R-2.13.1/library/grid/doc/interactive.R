### R code from vignette source 'interactive.Snw'

###################################################
### code chunk number 1: interactive.Snw:18-22
###################################################
library(grDevices)
library(grid)
...
###################################################
### code chunk number 11: interactive.Snw:124-130
###################################################
gxa <- xaxisGrob(at = 1:4/5, vp = viewport(w = .5, h = .01))
gxa <- editGrob(gxa, gp = gpar(col = "red"))
gxa <- editGrob(gxa, gPath = "labels", gp = gpar(col = "green"))
