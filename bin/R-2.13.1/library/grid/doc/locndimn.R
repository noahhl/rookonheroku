### R code from vignette source 'locndimn.Snw'

###################################################
### code chunk number 1: locndimn.Snw:20-24
###################################################
library(grDevices)
library(grid)
...
###################################################
### code chunk number 2: locndimn.Snw:52-91
###################################################
...
###################################################
### code chunk number 3: locndimn.Snw:102-114
###################################################
