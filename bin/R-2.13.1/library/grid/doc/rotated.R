### R code from vignette source 'rotated.Snw'

###################################################
### code chunk number 1: rotated.Snw:18-24
###################################################
library(grDevices)
...
###################################################
### code chunk number 2: rotated.Snw:30-33
###################################################
...
###################################################
### code chunk number 9: rotated.Snw:139-145
###################################################
x <- rnorm(50)
y <- x + rnorm(50, 1, 2)
# We will extend the axes over the entire region so
